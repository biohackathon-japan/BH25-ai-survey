...
authors_short: Feriau L \emph{et al.}
---
...
(F) BioHackathon participation history 
(G) Primary research fields

### AI usage and AI tools

The survey results on AI usage distribution show that 10 people are AI developers and researchers, 92 people are AI users and one is not an AI-user. Among the AI-users, the majority of respondents (61) reported using AI everyday, while another 23 use it a few times a week, and 8 use it a few times a month (Figure 3A). Overall, this indicates that most participants are frequent AI users, with only a small minority not engaging with AI tools.
...
(A) Frequency of AI use
(B) AI tools used
(C) AI application by task and assistance level
...
(A) Overall user satisfaction with AI
(B) Satisfaction stratified by language group
(C) Correlation between institutional support and user satisfaction 
...
Private Sector shows an overwhelming support compared to academia and public sector, with around 60% of the respondents indicating a very good support from their institution, compared to only 15.3% (Academia) to 26.7% (Public sector) of the respondents indicating the same level of support (Figure 6B).

Workers of the EU, US and other countries indicate little to no support from their institutions (48.4% at 1 to 2 on the scale) compared to their counterparts in Japan (30.3% for the same score) or Thailand (13% for the same score) (Figure 6C). The proportion of them indicating a very good support is also almost half (16.1%) of workers in Japan (27.9%) and Thailand (26.1%).
...
(C) Support level by work country
